...
public class Task1_GuestCheckIn {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            try (URLClassLoader loader =
                ...
                System.out.println("🏨 [ACTION]: Checking in Guest Rahul...");

                stmt.executeUpdate(
                        "INSERT INTO hotel_bookings (guest_name, room_no, price) " +
                        "VALUES ('Rahul', 101, 5000.00)"
                );

                System.out.println("✅ [RESULT]: Guest Rahul checked into Room 101 successfully!");
                System.out.println("📋 Verify in XAMPP → Refresh hotel_bookings table.");

    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            try (URLClassLoader loader =
                ...
                System.out.println("📚 [ACTION]: Adding new book stock...");

                int rows = stmt.executeUpdate(
                        "INSERT INTO books (book_name, price) " +
                        "VALUES ('Python Pro', 300)"
                );

                if (rows > 0) {
                    System.out.println("✅ [RESULT]: Book 'Python Pro' added successfully!");
                } else {
                    System.out.println("❌ [RESULT]: Book insertion failed.");
                }

                System.out.println("📋 Verify in XAMPP → Check books table.");
